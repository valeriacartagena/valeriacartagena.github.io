...
function Home() {
  ...
  const news = [
    ...
    },
    {
      ...
      text: (
        <>
          Completed my summer internship at <a href="https://www.twelve.co/" target="_blank" rel="noopener noreferrer">Twelve</a>, a carbon-transformation unicorn turning CO₂ into essential chemicals and sustainable aviation fuels, under the Strategy & Special Projects team.
        </>
      )
    }
  ];
