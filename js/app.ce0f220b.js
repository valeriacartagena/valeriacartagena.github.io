...
`,M=i["b"].div`
  margin: 36px 0px;
`;var A={components:{Background:z,Container:T,TextContainer:D,CtaSection:M,Heading:L,Subtitle:m,Paragraph:p,StyledButton:$,ButtonText:h},props:{author:String,cta:String,subtitle:String,description:Array}},V=A,I=Object(F["a"])(V,s,d,!1,null,null,null),H=I.exports,R=function(){var e=this,t=e.$createElement,n=e._self._c||t;return n("card",[n("contents",[n("product-title",[e._v(e._s(e.name))]),n("paragraph",[e._v(e._s(e.description))])],1),n("div",[n("styled-button",{attrs:{href:e.link.url,target:"_blank"}},[n("button-text",[e._v(e._s(e.link.name))]),n("i",{staticClass:"fas fa-arrow-right"})],1)],1)],1)},W=[];const Y=i["b"].div`
  /* width: 100px; */
  height: 200px;
  flex: 1;
  display: flex;
