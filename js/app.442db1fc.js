...
`,M=i["b"].div`
  margin: 36px 0px;
`;var A={components:{Background:B,Container:T,TextContainer:D,CtaSection:M,Heading:L,Subtitle:m,Paragraph:p,StyledButton:$,ButtonText:h},props:{author:String,cta:String,subtitle:String,description:Array}},V=A,I=Object(E["a"])(V,s,d,!1,null,null,null),R=I.exports,W=function(){var e=this,t=e.$createElement,n=e._self._c||t;return n("card",[n("contents",[n("product-title",[e._v(e._s(e.name))]),n("paragraph",[e._v(e._s(e.description))])],1),n("div",[n("styled-button",{attrs:{href:e.link.url,target:"_blank"}},[n("button-text",[e._v(e._s(e.link.name))]),n("i",{staticClass:"fas fa-arrow-right"})],1)],1)],1)},H=[];const Y=i["b"].div`
  /* width: 100px; */
  height: 200px;
  flex: 1;
  display: flex;
...
`,ne=i["b"].img`
  ...
  filter: invert(1);
  opacity: 0.8;
`;var re={components:{Card:te,Logo:ne,StyledA:ee},props:{src:String,url:String,alt:String}},ae=re,oe=Object(E["a"])(ae,q,K,!1,null,null,null),ie=oe.exports,se=function(){var e=this,t=e.$createElement,n=e._self._c||t;return n("app-footer",[n("div",[n("subtitle",[e._v(e._s(e.footer.tagline))])],1),n("icon-container",e._l(e.footer.links,(function(e,t){return n("icons",{key:"product-desctiption-"+t,attrs:{href:e.url,target:"_blank"}},[n("i",{class:e.fa})])})),1)],1)},de=[];const le=i["b"].div`
