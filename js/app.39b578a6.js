...
`,M=i["b"].div`
  margin: 36px 0px;
`;var A={components:{Background:B,Container:T,TextContainer:D,CtaSection:M,Heading:L,Subtitle:m,Paragraph:p,StyledButton:$,ButtonText:h},props:{author:String,cta:String,subtitle:String,description:Array}},V=A,I=Object(z["a"])(V,s,d,!1,null,null,null),R=I.exports,W=function(){var e=this,t=e.$createElement,n=e._self._c||t;return n("card",[n("contents",[n("product-title",[e._v(e._s(e.name))]),n("paragraph",[e._v(e._s(e.description))])],1),n("div",[n("styled-button",{attrs:{href:e.link.url,target:"_blank"}},[n("button-text",[e._v(e._s(e.link.name))]),n("i",{staticClass:"fas fa-arrow-right"})],1)],1)],1)},H=[];const Y=i["b"].div`
  /* width: 100px; */
  height: 200px;
  flex: 1;
  display: flex;
...
`,ne=i["b"].img`
  ...
  filter: invert(1);
  opacity: 0.8;
`;var re={components:{Card:te,Logo:ne,StyledA:ee},props:{src:String,url:String,alt:String}},ae=re,oe=Object(z["a"])(ae,q,K,!1,null,null,null),ie=oe.exports,se=function(){var e=this,t=e.$createElement,n=e._self._c||t;return n("app-footer",[n("div",[n("subtitle",[e._v(e._s(e.footer.tagline))])],1),n("icon-container",e._l(e.footer.links,(function(e,t){return n("icons",{key:"product-desctiption-"+t,attrs:{href:e.url,target:"_blank"}},[n("i",{class:e.fa})])})),1)],1)},de=[];const le=i["b"].div`
...
`;var Pe={name:"Home",components:{Hero:R,Card:O,MinorCard:Z,MinorCardContainer:$e,Foot:ge,ThemeProvider:i["a"],CardContainer:_e,LightToggle:je,MainTitle:l,LogoContainer:Ce,LogoSectionContainer:Se,LogoCard:ie},computed:{theme(){return we.dark?fe:be},isDark(){return we.dark}},methods:{toggleTheme:()=>{ke.toggleDark(),ye()}},data:()=>({...xe})};ve();var Ee=Pe,ze=(n("034f"),Object(z["a"])(Ee,a,o,!1,null,null,null)),Fe=ze.exports,Oe=n("8c4f"),Be=function(){var e=this,t=e.$createElement,n=e._self._c||t;return n("div",{staticStyle:{padding:"20px"}},[n("h1",[e._v("Climate Change")]),n("p",[e._v("This page discusses environment and climate.")]),n("router-link",{attrs:{to:"/"}},[e._v("← Back to Home")])],1)},Te=[],De={name:"Climate"},Le=De,Me=Object(z["a"])(Le,Be,Te,!1,null,null,null),Ae=Me.exports,Ve=function(){var e=this,t=e.$createElement,n=e._self._c||t;return n("div",{staticStyle:{padding:"20px"}},[n("h1",[e._v("Energy")]),n("p",[e._v("This is the Energy page.")]),n("router-link",{attrs:{to:"/"}},[e._v("← Back to Home")])],1)},Ie=[],Re={name:"EnergyPage"},We=Re,He=Object(z["a"])(We,Ve,Ie,!1,null,null,null),Ye=He.exports,Ge=function(){var e=this,t=e.$createElement,n=e._self._c||t;return n("div",{staticStyle:{padding:"20px"}},[n("h1",[e._v("Projects")]),n("p",[e._v("Details about our latest projects and case studies.")]),n("router-link",{attrs:{to:"/"}},[e._v("← Back to Home")])],1)},Ne=[],Ue={name:"ProjectsPage"},Je=Ue,Xe=Object(z["a"])(Je,Ge,Ne,!1,null,null,null),Qe=Xe.exports,Ze=function(){var e=this,t=e.$createElement,n=e._self._c||t;return n("div",{staticStyle:{padding:"20px"}},[n("h1",[e._v("Books")]),n("p",[e._v("A collection of recommended books about climate, energy, and environment.")]),n("router-link",{attrs:{to:"/"}},[e._v("← Back to Home")])],1)},qe=[],Ke={name:"BooksPage"},et=Ke,tt=Object(z["a"])(et,Ze,qe,!1,null,null,null),nt=tt.exports;r["a"].use(Oe["a"]);var rt=new Oe["a"]({mode:"hash",routes:[{path:"/climate",component:Ae},{path:"/energy",component:Ye},{path:"/projects",component:Qe},{path:"/books",component:nt}]});r["a"].config.productionTip=!1,new r["a"]({router:rt,render:e=>e(Fe)}).$mount("#app")},"85ec":function(e,t,n){}});
//# sourceMappingURL=app.39b578a6.js.map